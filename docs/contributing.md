...
OSL Python package could always use more documentation,
whether as part of the official OSL Python package docs,
...
Ready to contribute? Here’s how to set up `osl-python-package` for local development.

1.  Fork the `osl-python-package` repo on GitHub.

2.  Clone your fork locally::

    $ git clone git@github.com:your_name_here/osl-python-package.git

3.  Install your local copy into a virtualenv. Assuming you have
    virtualenvwrapper installed, this is how you set up your fork for
    local development::

    $ mkvirtualenv osl-python-package
    $ cd osl-python-package/
...
```
$ pytest tests.test_osl_python_package
```
